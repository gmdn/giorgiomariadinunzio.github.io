...
[PDF](paper.pdf){.nw-btn .nw-btn-primary target="_blank"} [DOI](https://doi.org/10.1016/j.ipm.2014.04.008){.nw-btn target="_blank"} [BibTeX](cite.bib){.nw-btn target="_blank"}
